...

{
    ...
    $query= "SELECT * FROM price WHERE CONCAT(flight,hotel_night) <='{$priceToSearch}'";
...
<a style=" position:relative; top:-5vh;left:180vh;color:#85586F;text-decoration:none; text-shadow: 2px 2px #F8EDE3;font-size:3vh;"href="../php/user.php"><i><b>HomePage</i></b></a>
   ...
   <form action="../php/user_price.php" method="post">
    ...
    <table class="new_row" >
        <thead>
        <tr style="position:relative;left:65vh; font-weight:bold;top:10vh;">
            ...
            <th style="position:relative;left:5vh;color:#DFD3C3;background-color:#85586F;">Zbor</th>
            <th style="position:relative;left:7vh;color:#DFD3C3;background-color:#85586F;">Hotel</th>
         ...
         while($row = mysqli_fetch_array($search_result)):?>
             <tr style='position:relative;left:65vh;top:5vh;font-weight:bold;top:13vh;'>
              <td ><?php echo $row['id'];?></td>
               <td style='position:relative;left:3vh;'><?php echo  $row['destinatie'];?></td>
               <td style='position:relative;left:5vh;'><?php echo  $row['flight'];?></td>
               <td style='position:relative;left:7vh;'><?php  echo $row['hotel_night'];?></td>
